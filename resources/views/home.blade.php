...
<div id="page">
    ...
    <div class="page-content">
        ...
        <div class="row text-center mb-3">
            <a href="{{url('/')}}/menu?kejuruan=rpl" class="col-6 pr-2">
                <div class="card card-style mr-0  pt-4 mb-3">
                    ...
                    <h4 class="color-theme font-600">RPL</h4>
            ...
            <a href="{{url('/')}}/menu?kejuruan=tkr" class="col-6 pl-2">
                <div class="card card-style ml-0 mb-3 pt-4">
                    ...
                    <h4 class="color-theme font-600">TKR</h4>
                    <p class="mt-n2 font-11 color-highlight">
